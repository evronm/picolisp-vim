...
function! s:PicoLisp()
  ...
  syn match PicoLispParen /[\(\)]/ contained
  ...
  syn cluster PicoLispList contains=PicoLispStatement,PicoLispQuote,PicoLispParen,PicoLispVar,PicoLispGlobal,PicoLispAtom,PicolispComment,PicoLispCommentRegion,PicoLispString,PicolispStringRaw
