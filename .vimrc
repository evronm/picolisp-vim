...
function! s:PicoLisp()
  ...
  syn match PicoLispGlobal /*[A-Z]\+\S*/ contained
  ...
  "hi default link PicoLispClass Identifier
  ...
  hi def hlLevel0 ctermfg=red		guifg=red1  cterm=bold gui=bold
  hi def hlLevel1 ctermfg=yellow	guifg=orange1 cterm=bold gui=bold
  hi def hlLevel2 ctermfg=green	guifg=yellow1 cterm=bold gui=bold
  hi def hlLevel3 ctermfg=cyan	guifg=greenyellow cterm=bold gui=bold
  hi def hlLevel4 ctermfg=magenta	guifg=green1 cterm=bold gui=bold
  hi def hlLevel5 ctermfg=red		guifg=springgreen1 cterm=bold gui=bold
  hi def hlLevel6 ctermfg=yellow	guifg=cyan1 cterm=bold gui=bold
  hi def hlLevel7 ctermfg=green	guifg=slateblue1 cterm=bold gui=bold
  hi def hlLevel8 ctermfg=cyan	guifg=magenta1 cterm=bold gui=bold
  hi def hlLevel9 ctermfg=magenta	guifg=purple1 cterm=bold gui=bold
